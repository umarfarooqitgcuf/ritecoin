# Support for Output Descriptors in Riteccoin Core

Since Riteccoin Core v0.17, there is support for Output Descriptors in the
...
- Segwit addresses (bech32, of the form `rtc1...`, defined in [BIP 173](https://github.com/bitcoin/bips/blob/master/bip-0173.mediawiki)).
...
on Riteccoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Riteccoin Core wallets, a convenience function `combo` is
