...
* ritecoin.conf: contains configuration settings for ritecoind or ritecoin-qt
* ritecoind.pid: stores the process id of ritecoind while running
...
* debug.log: contains debug information and general logging generated by ritecoind or ritecoin-qt
