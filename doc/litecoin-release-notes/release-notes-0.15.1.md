Riteccoin Core version *0.15.1* is now available from:

  <https://download.ritecoin.org/ritecoin-0.15.1/>
...
A number of changes to the way Riteccoin Core deals with peer connections and invalid blocks
