...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " ritecoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  ritecoin-tx [options] <hex-tx> [commands]  Update hex-encoded ritecoin transaction\n" +
            "or:     ritecoin-tx [options] -create [commands]   Create hex-encoded ritecoin transaction\n" +
            "\n";
