...
{
    const char* pszTimestamp = "NY Times 05/Oct/2019 Trump Governs by Grudge in California";
...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1570266508, 2084874682, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x31d4bb86a617044ef9a0f32165e1fd9a96ed6e8886d223b44df4d0cbcb67749d"));
        assert(genesis.hashMerkleRoot == uint256S("0x3f455b46f58094297d3b7b4d502b1b4759565f7d901863063f106143e7d51b87"));
       ...
       // vSeeds.emplace_back("seed-a.ritecoin.loshan.co.uk");
       // vSeeds.emplace_back("dnsseed.thrasher.io");
       // vSeeds.emplace_back("dnsseed.ritecointools.com");
       // vSeeds.emplace_back("dnsseed.ritecoinpool.org");
       // vSeeds.emplace_back("dnsseed.koin-project.com");
        ...
        checkpointData = {
            {
             {  0, uint256S("0x31d4bb86a617044ef9a0f32165e1fd9a96ed6e8886d223b44df4d0cbcb67749d")},
...
public:
    CTestNetParams() {
       ...
       // vSeeds.emplace_back("testnet-seed.ritecointools.com");
       // vSeeds.emplace_back("seed-b.ritecoin.loshan.co.uk");
       // vSeeds.emplace_back("dnsseed-testnet.thrasher.io");
        ...
        checkpointData = (CCheckpointData) {
            {
                {0, uint256S("31d4bb86a617044ef9a0f32165e1fd9a96ed6e8886d223b44df4d0cbcb67749d")},
            }
        };
...
public:
    CRegTestParams() {
        ...
        genesis = CreateGenesisBlock(1570266508, 2084874682, 0x207fffff, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x31d4bb86a617044ef9a0f32165e1fd9a96ed6e8886d223b44df4d0cbcb67749d"));
        assert(genesis.hashMerkleRoot == uint256S("0x3f455b46f58094297d3b7b4d502b1b4759565f7d901863063f106143e7d51b87"));
