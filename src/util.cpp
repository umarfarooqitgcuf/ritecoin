...
const char * const BITCOIN_CONF_FILENAME = "ritecoin.conf";
const char * const BITCOIN_PID_FILENAME = "ritecoin.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Riteccoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Riteccoin";
#else
    // Unix
    return pathRet / ".ritecoin";
#endif
#endif
}
