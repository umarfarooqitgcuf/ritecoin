...
"""Verify that starting ritecoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start ritecoin with -h for help text")
        ...
        self.log.info("Start ritecoin with -version for version information")
        ...
        self.log.info("Start ritecoind with -fakearg to make sure it does not start")
